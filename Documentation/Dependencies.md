...
| qpdf 12.4.1 + libjpeg-turbo 3.2.0 | qpdf Apache-2.0 with embedded permissive notices; libjpeg-turbo IJG/BSD/zlib terms | Hash-pinned static CLI pack `12.4.1-fileform.1`; sources, exact CMake caches, licenses and IJG attribution included. Native crypto; only Apple system zlib/libc++/libSystem runtime dependencies. See [PDF optimization](PDF-optimization.md). |
