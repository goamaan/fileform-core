...
Current outputs include JPEG/PNG/TIFF, MP4/MOV/M4A/WAV/FLAC with the media pack, PDF page/image/text operations, local OCR, and CSV/TSV/flat-JSON tables. See [supported routes and limits](Documentation/Support.md).
