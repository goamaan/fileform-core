...
struct FileformCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        version: "0.1.0-dev", subcommands: [Inspect.self, Capabilities.self, Convert.self, Compress.self, Fit.self, Transform.self, Setup.self, Preview.self, ImageCommand.self, PDFCommand.self, MediaCommand.self, FetchCommand.self])
}
